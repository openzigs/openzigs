...
## Summary
- 7024 nodes · 10418 edges · 158 communities detected
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 759 edges (avg confidence: 0.78)
...
- `hasVideoStream()` --calls--> `execFileAsync()`  [INFERRED]
  src/knowledge/converters/sidecar-media-converter.ts → src/api/files.ts

## Communities

### Community 0 - "Community 0"
Cohesion: 0.0
Nodes (157): createAirtableReadTools(), createAirtableWriteTools(), convertToMarkdown(), execFileAsync(), createOutboxRouter(), createAppWithCopilot(), createTemplatesRouter(), setup() (+149 more)

### Community 1 - "Community 1"
Cohesion: 0.0
Nodes (103): createCharacterRouter(), getCharactersDir(), getImageGenSidecarUrl(), getImageGenToken(), getPhotosDir(), pollTrainingStatus(), resumeStaleTrainingPolls(), startRemoteTraining() (+95 more)

### Community 2 - "Community 2"
Cohesion: 0.0
Nodes (162): injectCharacterLora(), appendTokenToAssetUrl(), appendTokenToPitchAssetUrls(), createPitchRouter(), buildHarness(), makeDraftedDeck(), makeSlide(), parseBody() (+154 more)
...
Cohesion: 0.0
Nodes (48): ChannelManager, WebChannel, FakeIOServer, FakeSocket, isExpired(), isRateLimitError(), isTimeoutError(), isUnauthorizedError() (+40 more)
...
Cohesion: 0.0
Nodes (97): buildApp(), createLocalLlmRouter(), defaultConfigPath(), ensureVllmApiKey(), generateVllmApiKey(), persistLocalLlmBlock(), readJson(), readLocalLlmBlock() (+89 more)
...
Cohesion: 0.0
Nodes (95): extractBlog(), extractImages(), extractMeta(), extractSurroundingText(), extractTagContent(), extractTitle(), htmlToText(), isPrivateIp() (+87 more)
...
Cohesion: 0.0
Nodes (69): createAppWithHandler(), createSeoRouter(), createApp(), AuditHistoryRepository, aggregateKeywords(), discoverCompetitorsFromAudit(), braveSearch(), discoverCompetitors() (+61 more)
...
Cohesion: 0.0
Nodes (28): createDirectorRouter(), buildApp(), createMockCopilot(), buildApp(), createMockCopilot(), createMockToolRegistry(), defaultDbPath(), getDatabase() (+20 more)
...
Cohesion: 0.0
Nodes (29): ConverterRegistry, createDefaultRegistry(), shutdownConverters(), createDocxConverter(), createImageOcrConverter(), createMediaConverter(), ffmpegAvailable(), resolveModelName() (+21 more)
...
Cohesion: 0.0
Nodes (8): extractTag(), fetchAndValidateSitemap(), isValidDate(), parseSitemapXml(), isValidDate(), isValidUrl(), validateJsonLdBlock(), validateStructuredData()
...
- **Thin community `Community 71`** (14 nodes): `ClipExtractor`, `.analyzeFrames()`, `.constructor()`, `.detectSceneChanges()`, `.extractFrames()`, `.getJob()`, `.getVideoDuration()`, `.listJobs()`, `.processNext()`, `.runExtraction()`, `.scoreAndExtractClips()`, `.submit()`, `.transcribeAudio()`, `.waitForCompletion()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (14 nodes): `RenderOrchestrator`, `.abort()`, `.cleanupWorker()`, `.constructor()`, `.getJob()`, `.handleWorkerError()`, `.handleWorkerMessage()`, `.listJobs()`, `.processQueue()`, `.shutdown()`, `.startWorker()`, `.submit()`, `.waitForCompletion()`, `resolvePath()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
