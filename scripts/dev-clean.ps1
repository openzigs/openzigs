...
.DESCRIPTION
    ...
    Lipsync/5010, SadTalker/5011, v2a/MMAudio/5012, ltx2/5013). This is the Windows equivalent
    of dev-clean.sh.
...
if (Get-Command wsl -ErrorAction SilentlyContinue) {
    $wslKillCmd = 'for p in 5005 5006 5007 5009 5010 5011 5012 5013; do lsof -ti :$p 2>/dev/null | xargs -r kill -9 2>/dev/null; done; pkill -f "sleep infinity" 2>/dev/null; true'
...
if (Get-Command wsl -ErrorAction SilentlyContinue) {
    Write-Info "Starting WSL CUDA sidecars (Flux/5005, Audio/5006, LTX/5007, Music/5009, Lipsync/5010, SadTalker/5011, v2a/5012, ltx2/5013)..."
    ...
    Write-Ok "WSL CUDA sidecars launched (Flux/5005, Audio/5006, LTX/5007, Music/5009, Lipsync/5010, SadTalker/5011, v2a/5012, ltx2/5013)"
...
Write-Host "  Sidecars (WSL):   5005 (Flux), 5006 (Audio), 5007 (LTX), 5009 (Music), 5010 (Lipsync), 5011 (SadTalker), 5012 (v2a/MMAudio), 5013 (ltx2 native) - loading in background"
Write-Host ""
Write-Host "  Logs:"
...
try {
    ...
    if (Get-Command wsl -ErrorAction SilentlyContinue) {
        ...
        $wslKillCmd = 'for p in 5005 5006 5007 5009 5010 5011 5012 5013; do lsof -ti :$p 2>/dev/null | xargs -r kill -9 2>/dev/null; done; true'
        wsl -d Ubuntu -e bash -c $wslKillCmd 2>&1 | Out-Null
    }
