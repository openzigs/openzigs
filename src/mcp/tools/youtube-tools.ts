...
const getChannelInfoSchema = z.object({
  channel_id: z
    ...
    .optional()
    .describe(
      "YouTube channel ID (uses authenticated channel if not provided)",
    ),
});
...
const uploadVideoSchema = z.object({
  ...
  privacy_status: z
    ...
    .optional()
    .describe("Video privacy (default: 'private')"),
...
const uploadCaptionsSchema = z.object({
  ...
  caption_name: z
    .string()
    .optional()
    .describe("Caption track name (default: 'English')"),
...
const callLocalServer = async (
  ...
  if (!manager.isRunning("youtube")) {
    return {
      text: "YouTube MCP server is not running. Check YOUTUBE_API_KEY env var.",
      isError: true,
    };
  }
...
export const createYouTubeTools = (
  options: YouTubeToolsOptions,
): ToolDefinition[] => {
  ...
  return [
    {
      ...
      source: "youtube",
      handler: async (args) =>
        callLocalServer(mgr, "yt_get_channel_info", args),
    },
    {
      ...
      source: "youtube",
      handler: async (args) =>
        callLocalServer(mgr, "yt_get_channel_videos", args),
    },
    {
      ...
      source: "youtube",
      handler: async (args) =>
        callLocalServer(mgr, "yt_get_video_details", args),
    },
    {
      ...
      source: "youtube",
      handler: async (args) =>
        callLocalServer(mgr, "yt_get_video_comments", args),
    },
    {
      ...
      inputSchema: {
        ...
        required: ["parent_comment_id", "text"],
      },
      ...
      source: "youtube",
      handler: async (args) =>
        callLocalServer(mgr, "yt_reply_to_comment", args),
    },
    {
    ...
    },
    {
      ...
      description:
        "Get YouTube channel analytics (views, subscribers, watch time).",
      inputSchema: {
        type: "object",
        properties: {
      ...
      source: "youtube",
      handler: async (args) =>
        callLocalServer(mgr, "yt_get_channel_analytics", args),
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          notify_subscribers: {
            type: "boolean",
            description: "Notify subscribers (default true)",
          },
        },
    ...
    },
    {
      ...
      description:
        "Check if a YouTube video still exists (not deleted/removed). Costs 1 quota unit.",
      inputSchema: {
        type: "object",
        properties: {
          video_id: {
      ...
      source: "youtube",
      handler: async (args) =>
        callLocalServer(mgr, "yt_check_video_exists", args),
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          caption_name: {
            type: "string",
            description: "Caption track name (default 'English')",
          },
